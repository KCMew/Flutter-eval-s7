...
class SeanceState extends State<WorkoutSessionsScreen> {
  ...
  final keys = boxDetailSeance.keys;
                        ...
                        Container(
                          ...
                          child: DropdownButtonFormField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                hintText: 'Choisissez le jour de la séance',
                                border: OutlineInputBorder(),
                              ),
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                setState(() {
                                  boxSeance.put(
                                    'key_$seanceNameController+$random',
                                    Seance(
                                      key: 'key_$seanceNameController+$random',
                                      nomSeance: seanceName,
                                      jourSeance: selectedJourType,
                                    ),
                                  );
                                });
                                seanceNameController.clear();
                              }
                            },
  ...
  int generateRandomNumber() {
    return Random().nextInt(1000000001);
  }
}
